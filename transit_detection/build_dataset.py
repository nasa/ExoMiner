...
# local
from transit_detection.utils_flux_processing import extract_flux_windows_for_tce, build_transit_mask_for_lightcurve
...
for (target, sector_run), sector_run_data in tce_tbl.groupby(['target_id','sector_run']):
    ...
    # print(f'Extracting and processing data for target {sector_run_data["target_id"][0]}...')
