...
from transit_detection.keras_model.utils_evaluate import write_performance_metrics_from_np_to_csv_file
...
def evaluate_model(config, model_path, res_dir, logger=None):
    ...
    for dataset in config['datasets']: 
        ...
        eval_input_fn = InputFn(file_paths=config['datasets_fps'][dataset], #list of train/val/test path, calls eval 
    ...
    write_performance_metrics_from_np_to_csv_file(np_path=res_dir / 'res_eval.npy', csv_path=res_dir / 'res_eval.csv')


    # TODO: add csv file via npy array or function to call
