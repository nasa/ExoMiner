...
INT64_FEATURES = ['target_id', 'tce_plnt_num', 'numberOfPlanets', 'tce_num_transits', 'tce_num_transits_obs',
                  'mag_cat', 'mission']
FLOAT_FEATURES = ['tce_max_sngle_ev', 'tce_max_mult_ev', 'tce_model_chisq', 'tce_depth', 'tce_period', 'tce_time0bk',
                  'tce_duration', 'tce_prad', 'tce_sma', 'tce_impact', 'boot_fap', 'tce_ror', 'tce_dor',
                  'tce_model_snr', 'tce_dikco_msky_err', 'tce_dikco_msky', 'tce_dicco_msky', 'tce_dicco_msky_err',
                  'mag', 'tce_sdens', 'tce_sradius', 'tce_steff', 'tce_slogg', 'tce_smet', 'tce_eqt', 'tce_robstat',
                  'tce_maxmes', 'tce_maxmesd', 'tce_bin_oedp_stat', 'tce_shortper_stat', 'tce_longper_stat',
                  'planetToiId', 'tce_incl', 'tce_eccen', 'tce_longp', 'ra', 'dec', 'tce_albedo', 'tce_albedo_stat',
                  'tce_ptemp', 'tce_ptemp_stat', 'tce_insol', 'tce_cap_stat', 'tce_hap_stat', 'wst_depth', 'ruwe',
                  'mag_shift']
BYTES_FEATURES = ['disposition', 'disposition_source', 'matched_object']

FEATURES_TO_TBL = ['target_id', 'tce_plnt_num', 'numberOfPlanets', 'tce_num_transits', 'tce_num_transits_obs',
                   'tce_max_sngle_ev', 'tce_max_mult_ev', 'tce_model_chisq', 'tce_depth', 'tce_period',
                   'tce_time0bk', 'tce_duration', 'tce_prad', 'tce_sma', 'tce_impact', 'boot_fap', 'tce_ror',
                   'tce_dor', 'tce_model_snr', 'tce_dikco_msky_err', 'tce_dikco_msky', 'tce_dicco_msky',
                   'tce_dicco_msky_err', 'mag', 'tce_sdens', 'tce_sradius', 'tce_steff', 'tce_slogg', 'tce_smet',
                   'tce_eqt', 'tce_robstat', 'tce_maxmes', 'tce_maxmesd', 'tce_bin_oedp_stat',
                   'tce_shortper_stat', 'tce_longper_stat', 'planetToiId', 'tce_incl', 'tce_eccen', 'tce_longp',
                   'ra', 'dec', 'tce_albedo', 'tce_albedo_stat', 'tce_ptemp', 'tce_ptemp_stat', 'tce_insol',
        ...
        for example_type in ['transit_examples', 'not_transit_examples']:
            ...
            for example_i in range(len(data_for_sector[example_type]['t'])):
                ...
                for feature_name in INT64_FEATURES:
                    example_util.set_int64_feature(example, feature_name,
                                                   [data_for_tce['tce_info'][feature_name]])
                for feature_name in FLOAT_FEATURES:
                    example_util.set_float_feature(example, feature_name,
                                                   [data_for_tce['tce_info'][feature_name]])
                for feature_name in BYTES_FEATURES:
                    example_util.set_bytes_feature(example, feature_name,
                                                   [data_for_tce['tce_info'][feature_name]])

                # set features for example
                example_util.set_float_feature(example, 't',
                                               [data_for_sector[example_type]['t'][example_i]])
...
def write_data_to_auxiliary_tbl(data_to_tfrec, tfrec_fp):
    ...
    data_to_tbl = {field_name: [] for field_name in
                   ['tce_uid', 'n_transit_examples', 'n_not_transit_examples', 'tfrec_fn']}
    ...
    for data_for_tce in data_to_tfrec:
        ...
        data_to_tbl['n_transit_examples'].append(np.sum([len(data_for_sector['transit_examples']['t'])
                                                         for data_for_sector in data_for_tce['sectors']]))
        data_to_tbl['n_not_transit_examples'].append(np.sum([len(data_for_sector['not_transit_examples']['t'])
                                                             for data_for_sector in data_for_tce['sectors']]))
