"""
Plot the correlation between the score and planet radius to see if the model is classifying bigger objects as Brown
Dwarfs at a higher rate. Graph plotted for each set in total dataset and for each set in each fold when doing
cross-validation.
"""
