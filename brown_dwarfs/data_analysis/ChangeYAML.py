...
import yaml
"""
Change the dataset_fps YAML File in config_train to change fold for n fold cross_validation. Takes in an argument of 
the new dataset_fps.yaml filepath.
"""

parser = argparse.ArgumentParser()
parser.add_argument('--current_dataset_fp', type=str, help='File path to YAML configuration file.',
                    default=None)
