...
import numpy as np
"""
Generate the train test and validation folds for n-fold cross validations. Allows for a non-even splits of train test, and validation eg: 60% 10% 30%
"""

data_dir = Path('/Users/agiri1/Desktop/ExoBD_Datasets/shard_tables/')
cv_list = []
paths = [[fp for fp in sorted(Path(f'/Users/agiri1/Desktop/ExoBD_Datasets/shard_tables/tfrecords/eval').iterdir())] for num in range(5)]
print(len(paths))
test_folds = 10
val_folds = 4
