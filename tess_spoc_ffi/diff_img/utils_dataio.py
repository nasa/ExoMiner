...
class InputFn(object):
    ...
    def __init__(self, file_paths, batch_size, mode, label_map, features_set, data_augmentation=False,
                 ...
                 feature_map=None, label_field_name='label', filter_fn=None, set_label_id=False):
        ...
        self.set_label_id = set_label_id
    ...
    def __call__(self):
        ...
        def _example_parser(serialized_example):
            ...
            if include_labels:
                ...
                label_field = {self.label_field_name: tf.io.FixedLenFeature([], tf.float32)}
            ...
            if self.set_label_id:
                ...
                label_id = parsed_label[self.label_field_name]
