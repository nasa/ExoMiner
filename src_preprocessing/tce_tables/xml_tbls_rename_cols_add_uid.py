...
if __name__ == '__main__':
    ...
    src_tbl_fp = Path('/nobackupp19/msaragoc/work_dir/Kepler-TESS_exoplanet/data/Ephemeris_tables/TESS/tess_spoc_ffi/tess-spoc-ffi-tces-dv_s73-s81_3-20-2026_0951/tess-spoc-ffi-tces-dv_s73-s81_3-20-2026_0951.csv')
