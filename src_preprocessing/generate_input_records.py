...
class Config:
    ...
    gapped = True  # Gap transits in lightcurve correponding to other TCE's?
    ...
    stats_preproc_filepath = '/home6/msaragoc/work_dir/data/EXOPLNT_Kepler-TESS/stats_trainingset.npy'

    # output directory
    output_dir = "tfrecords/tfrecord{}_dr25_centroidfdlnormalized".format(satellite)
    # working directory
    w_dir = '/home6/msaragoc/work_dir/HPO_Kepler_TESS/src_preprocessing'  # os.path.dirname(__file__)
    ...
    tps_ephem_tbl = '/home6/msaragoc/work_dir/data/EXOPLNT_Kepler-TESS/Ephemeris_tables/Kepler/tpsTceStructV4_KSOP2536.mat'
