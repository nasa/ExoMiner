...
`create_table_for_tfrecord_dataset()` in [src_preprocessing/utils_manipulate_tfrecords.py](../utils_manipulate_tfrecords.py). See the 
...
Using script [compute_normalization_stats_tfrecords.py](./compute_normalization_stats_tfrecords.py) along with [config_compute_normalization_stats.yaml](./config_compute_normalization_stats.yaml), you can 
...
Using script [normalize_data_tfrecords.py](./normalize_data_tfrecords.py) along with [config_normalize_data.yaml](./config_normalize_data.yaml), create a normalize TFRecord dataset 
