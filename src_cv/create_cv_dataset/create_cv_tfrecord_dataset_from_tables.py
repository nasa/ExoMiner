...
if __name__ == '__main__':
    ...
    dest_dir = Path('/Users/agiri1/Desktop/ExoBD_Datasets/shard_tables')
    # TFRecord source directory
    src_tfrec_dir = Path('/Users/agiri1/Desktop/ExoBD_Datasets')
    # table that maps a TCE to a given TFRecord file in the source TFRecords
    src_tfrec_tbl_fp = Path('/Users/agiri1/Desktop/ExoBD_Datasets/shards_tbl.csv')
    n_processes = 10
    # directory with the TCE tables for each fold in the labeled data set
    labeled_shard_tbls_dir = Path('/Users/agiri1/Desktop/ExoBD_Datasets/shard_tables/eval')  # dest_dir / 'shard_tables' / 'eval'
