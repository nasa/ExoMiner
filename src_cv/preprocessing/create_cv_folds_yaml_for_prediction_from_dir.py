...
def create_cv_folds_yaml_for_prediction_from_dir(data_dir, config, cv_iter):
    """ Run setup for inference in a CV iteration . This involves adding the filepaths for this given iteration to the
...
if __name__ == "__main__":
    ...
    create_cv_folds_yaml_for_prediction_from_dir(data_dir_fp, cv_iter_config, args.cv_iter)
