...
1. plot recall/prec threshold values of multiple experiments on same graph
2. Used to easily compare recall/prec values between experiments
'''
...
for ranking_tbl in ranking_tbls:
    ...
    total_1 = ranking_tbl.loc[ranking_tbl['label'] == 1].shape[0]
