...
def plot_binseries_flux(all_time, all_flux, binary_time_all, tce, savedir, basename):
    ...
    plt.suptitle('Kepid {} | TCE {} | {}'.format(tce['kepid'], tce['tce_plnt_num'], tce['av_training_set']))
...
def plot_centroids(time, centroids, centroids_spline, tce, px_coordinates, savedir, basename, add_info=None):
    ...
    time-series
    :param tce: pandas Series, row of the input TCE table Pandas DataFrame.
    :param px_coordinates: bool, if True assumes centroid position is in pixels, RA and Dec otherwise
    :param savedir: str, filepath to directory in which the figure is saved
    :param basename: str, added to the figure filename
...
def plot_flux_fit_spline(time, flux, spline_flux, tce, savedir, basename):
...
def plot_centroids_it_oot(all_time, binary_time_all, all_centroids, centroid_oot, avg_centroid_oot, target_coords, tce,
                          px_coordinates, savedir, basename):
...
def plot_corrected_centroids(all_time, all_centroids, avg_centroid_oot, target_coords, tce, px_coordinates, savedir,
                             basename):
...
def plot_centroids_views(glob_view_centr, loc_view_centr, tce, savedir, basename):
...
def plot_fluxandcentroids_views(glob_view, loc_view, glob_view_centr, loc_view_centr, tce, savedir, basename):
...
def plot_all_views(views, tce, scheme, savedir, basename):
