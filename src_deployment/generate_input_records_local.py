...
from src_deployment.utils_generate_input_records import get_kepler_tce_table, get_tess_tce_table, \
...
class Config:
    ...
    output_dir = "tfrecords/tfrecord{}_testcentroidpreprocessing2".format(satellite)
    # working directory
