...
dv_root_dir = Path('/Users/msaragoc/Projects/exoplanet_transit_classification/data/ephemeris_tables/tess/DV_SPOC_mat_files/')
...
ssector_runs_fps = [fp for fp in ssector_runs_fps if fp.name.startswith('dvOutput') and int(fp.stem[14:]) in range(53, 68 + 1)]  # ssector_runs_fps[-6:]

msector_runs_fps = list(msector_runs_dir.iterdir())
# FILTERING MULTI-SECTOR RUNS
msector_runs_fps = [fp for fp in msector_runs_fps if fp.name.startswith('dvOutput') and fp.stem[14:] in ['0165', '1460', '1455']]
