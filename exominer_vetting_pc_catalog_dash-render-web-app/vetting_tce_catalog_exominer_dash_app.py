...
tooltips = {
    ...
    'ExoMiner Score': 'ExoMiner model score in [0, 1]. The model is more confident that the TCE is a planet candidate as the score gets closer to one. It is NOT a probability',
...
app.layout = html.Div([
    ...
    dcc.Input(id='sector-run-filter', type='text', placeholder='Filter TCEs by Sector Run using regex patterns (e.g., 14, 14-60, -60)', style={'display': 'flex', 'flexDirection': 'column', 'width': '100%'}),
    ...
    html.H2(["🌎 Created by ", html.A("Miguel Martinho", href='https://migmartinho.github.io/', target="_blank"), "🪐"],
            style={
                'color': '#79a4b5',
                'fontSize': '15px',
                'fontWeight': 'bold',
