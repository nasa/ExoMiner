    ...
    if args.optimizer == 'bohb':
        ...
        for bdgt in kde_models_bdgt:
            for est in kde_models_bdgt[bdgt]:
                kde_models_bdgt_params[bdgt][est] = [kde_models_bdgt[bdgt][est].data, kde_models_bdgt[bdgt][est].data_type,
...
if __name__ == '__main__':
    ...
    prev_run_dir = '/home/msaragoc/Kepler_planet_finder/configs/study_8/'
    # prev_run_dir = '/home6/msaragoc/work_dir/HPO_Kepler_TESS/logs/study_5/'

    # tfrec_dir = '/home6/msaragoc/work_dir/data/tfrecord_kepler'
    tfrec_dir = '/home/msaragoc/Kepler_planet_finder/tfrecord_kepler'  # DR24 non-whitened and non-gapped TCEs; old labels; Shallue used this data
