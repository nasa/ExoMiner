"""
Plot the misclassified and correctly classified Brown Dwarfs with respect to planet radius and period to see if the
misclassifications are concentrated in a certain area. Graph plotted for each set in total dataset and for each set in
each fold when doing cross-validation
"""
