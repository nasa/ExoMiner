...
if __name__ == '__main__':
    ...
    predictions_tbls = [
        pd.read_csv('/Users/msaragoc/Projects/exoplanet_transit_classification/experiments/kepler_simulated_data_exominer/exominer_predict_inj1_10-16-2023_1041/cv_iter_0/ensemble_ranked_predictions_predictset.csv'),
        pd.read_csv(
            '/Users/msaragoc/Projects/exoplanet_transit_classification/experiments/kepler_simulated_data_exominer/exominer_predict_inj2_10-16-2023_1041/cv_iter_0/ensemble_ranked_predictions_predictset.csv'),
        pd.read_csv(
            '/Users/msaragoc/Projects/exoplanet_transit_classification/experiments/kepler_simulated_data_exominer/exominer_predict_inj3_10-16-2023_1041/cv_iter_0/ensemble_ranked_predictions_predictset.csv'),
        pd.read_csv(
            '/Users/msaragoc/Projects/exoplanet_transit_classification/experiments/kepler_simulated_data_exominer/exominer_predict_inv_10-16-2023_1041/cv_iter_0/ensemble_ranked_predictions_predictset.csv'),
    ]
    predictions_tbl = pd.concat(predictions_tbls, axis=0)
    predictions_tbl.to_csv(Path('/Users/msaragoc/Projects/exoplanet_transit_classification/experiments/kepler_simulated_data_exominer/') / 'ensemble_ranked_predictions_predictset_inj_inv.csv', index=False)

    # saving csv file with computed performance metrics
    # save_fp = predictions_tbl_fp.parent / 'metrics_inj_inv.csv'
    save_fp = Path('/Users/msaragoc/Projects/exoplanet_transit_classification/experiments/kepler_simulated_data_exominer/') / 'metrics_inj_inv.csv'
    ...
    num_thresholds = 1000
    clf_threshold = 0.5
    top_k_vals = [50, 100, 150, 200, 500, 1000, 5000, 10000, 20000, 30000, 40000, 45000]
    # top_k_vals = []
    class_name = 'label_id'
    cat_name = 'label'
    multiclass = False
