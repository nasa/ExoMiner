...
CONFIG_FILE_DIR=/Users/msaragoc/Library/CloudStorage/OneDrive-NASA/Projects/exoplanet_transit_classification/experiments/shap_kepler-tess_cycle4/shap_01-26-2023_1542/
...
PRED_SCRIPT="/Users/msaragoc/OneDrive - NASA/Projects/exoplanet_transit_classification/codebase/src/predict_ensemble_keras.py"
...
#     python "$TRAIN_SCRIPT" --config_file="$CONFIG_FILE_DIR$line"_train.yaml
     python "$PRED_SCRIPT" --config_file="$CONFIG_FILE_DIR"runs_configs/"$line"_predict.yaml
 done
